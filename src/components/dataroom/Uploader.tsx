...
/**
 * Zone de dépôt + point d'entrée du bouton « Déposer des fichiers ».
 *
 * La ref exposée se comporte comme un bouton : le panneau parent peut donc
 * ouvrir le sélecteur de fichiers sans dupliquer la logique d'upload.
 */
export const Uploader = forwardRef<HTMLButtonElement, UploaderProps>(
  function Uploader({ orgId, dealId, folderId, folderIndex }, ref) {
