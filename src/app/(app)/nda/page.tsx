...
export default async function NdaPage() {
  ...
  return (
    <div className="text-[#1A1B1F]">
      ...
      <div style={mono} className="bg-white grid grid-cols-[2fr_1.3fr_1.1fr_90px] gap-3 px-2 pt-3 pb-2 border-b border-[#E2DED4] text-[9px] tracking-[0.08em] text-[#A0A3AB]">
      ...
      {ndas.length === 0 ? (
        ...
        ndas.map((n) => (
          <div key={n.id} className="bg-white grid grid-cols-[2fr_1.3fr_1.1fr_90px] gap-3 items-center px-2 py-3.5 border-b border-[#E8E5DC] hover:bg-[#FAF8F4]">
