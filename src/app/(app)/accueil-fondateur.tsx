...
export async function AccueilFondateur({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Résumé de la levée */}
      <div className="bg-white border border-[#E2DED4] rounded-[6px]">
        <div className="bg-white flex items-center justify-between px-[18px] py-3.5 border-b border-[#E2DED4]">
        ...
        <div className={"grid grid-cols-2 " + (estLevee ? "md:grid-cols-[1.4fr_1fr_1fr_1fr]" : "md:grid-cols-3")}>
          ...
          {/* Dossier prêt */}
          <Link href="/checklist" className="px-[18px] py-4 border-r border-[#E2DED4] hover:bg-[#FAF8F4] transition-colors">
          ...
          <Link href={estLevee ? "/deal" : "/permissions"} className="px-[18px] py-4 border-r border-[#E2DED4] hover:bg-[#FAF8F4] transition-colors">
        ...
        <div>
          ...
          {visites.length === 0 ? (
            ...
            <div className="border-t border-[#E2DED4]">
              ...
              {visites.map((v, i) => (
                <div key={i} className="bg-white flex items-center gap-3 py-2.5 border-b border-[#E8E5DC] hover:bg-[#FAF8F4]">
